...
/*
 * This file originally comes from https://github.com/coyim/gotk3osx/blob/main/gtkosx.go
...
func GetBundlePath() string {
	return cstring(C.gtkosx_application_get_bundle_path())
}
...
func GetResourcePath() string {
	return cstring(C.gtkosx_application_get_resource_path())
}

// GetExecutablePath returns the executable path, including file name
func GetExecutablePath() string {
	return cstring(C.gtkosx_application_get_executable_path())
}
...
func GetBundleID() string {
	return cstring(C.gtkosx_application_get_bundle_id())
}
...
func GetBundleInfo(key string) string {
	...
	return cstring(C.gtkosx_application_get_bundle_info(cstr))
}
