...
type V2ParserVisitor interface {
	...
	// Visit a parse tree produced by V2Parser#varWithIdx.
	VisitVarWithIdx(ctx *VarWithIdxContext) interface{}
	...
	// Visit a parse tree produced by V2Parser#assgnStmt.
	VisitAssgnStmt(ctx *AssgnStmtContext) interface{}
